...
//        title = "Browse"
    ...
    private func fetchData() {
        ...
        group.notify(queue: .main) {
            ...
            self.confiureModels(newAlbums: newAlbums,
                                playlists: playlists,
                                tracks: tracks)
        }
    }

    private func confiureModels(
        newAlbums: [Album],
        playlists: [Playlist],
        tracks: [AudioTrack]
    ) {
...
//        }
//        navigationController?.navigationBar.frame.size.height = titleHeight
//    }
//}
